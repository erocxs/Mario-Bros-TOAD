...
from src.components.moneda import moneda
from src.utils.constantsmario import NIVEL_1 
...
class Level1State:
    ...
    def instanciar_objetos(self):
        ...
        moneda.ARRAY_DESACTIVADAS.clear()
        if hasattr(hongo, 'ARRAY_DESACTIVADAS'):
            hongo.ARRAY_DESACTIVADAS.clear()

        # 3. RESTAURAR EL MAPA ORIGINAL
        # Importamos las constantes para resetear el diseño del nivel
        
        NIVEL_1[:] = NIVEL_1_ORIGINAL[:]
